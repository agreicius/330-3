...
},
{
  "id": "d_conjugates",
  "level": "2",
  "url": "s_Gal_corr_proof.html#d_conjugates",
  "type": "Definition",
  "number": "1.17.2",
  "title": "Galois conjugates and fix subgroups.",
  "body": " Galois conjugates and fix subgroups   Let be a finite Galois extension, and let . Given , a Galois conjugate (or just conjugate ) of is an element of the form , where . We denote by the set of all conjugates of : , . The stabilizer subgroup of , denoted , is the set of all elements of that fix : , .   "
},
{
  "id": "cor_Gal_corr",
  "level": "2",
  "url": "s_Gal_corr_proof.html#cor_Gal_corr",
  "type": "Corollary",
  "number": "1.17.3",
  "title": "Simple subfields of Galois extensions.",
  "body": " Simple subfields of Galois extensions   Let be a finite Galois extension with Galois group , let be an element of , and let be the set of Galois conjugates of .        .   .   Given an intermediate field , we have if and only if for all .  In particular, if and only if for all .    Given an intermediate field we have if and only if .  In particular, we have if and only if .      "
},
{
