...
{
  "id": "th_fin_cyclotomic",
  "level": "2",
  "url": "s_cyclotomic.html#th_fin_cyclotomic",
  "type": "Theorem",
  "number": "1.19.11",
  "title": "Finite fields are cyclotomic.",
  "body": " Finite fields are cyclotomic   Any finite extension of finite fields is cyclotomic.    The argument above proves the result in the special case of extensions of the form . For the more general case , note that we have for some prime integer . The special case then gives us for some -th root of unity .   "
},
{
  "id": "th_",
  "level": "2",
  "url": "s_cyclotomic.html#th_",
  "type": "Theorem",
  "number": "1.19.12",
  "title": "Galois theory of finite fields.",
  "body": " Galois theory of finite fields   Let be a prime integer, let be an algebraic closure of , and let be the Frobenius automorphism: , for all . For each positive integer , let be the unique subfield of of degree over .   For all positive integers , the extension is Galois, and is cyclic, generated by the restriction of to . In other words, we have , where by abuse of notation we write for the restriction .    For any positive integers with , the extension is Galois, and is cyclic generated by the restriction of to . In other words, we have we have , where by abuse of notation we write for the restriction .       This was a homework exercise.   "
},
{
  "id": "s_Gal_poly",
  "level": "1",
...
},
{
  ...
  "number": "1.21.8",
  "title": "Cubic resolvent.",
  "body": " Cubic resolvent   Let be a degree-4 polynomial, and let be its cubic resolvent.    .     . In particular, we have the special cases .    The discriminant of is equal to the discriminant of . In particular, has no repeated roots if and only if has no repeated roots.       Statement (1) follows from (2), which can be proved using symmetric polynomial techniques that are outside the scope of this course. Statement (3) follows from the definition of the discriminant, and is left as an exercise.   "
},
{
  "id": "th_Gal_quartic",
  "level": "2",
