...
},
{
  ...
  "number": "1.19.3",
  "title": "",
  "body": "  Let be an algebraic closure of . Given a positive integer the -th cyclotomic polynomial is the polynomial defined as follows: , where is any primitive -th root of unity. Note that since the number of primitive -th roots of unity is , we have .   "
},
{
  "id": "eg_cyc_polys",
  "level": "2",
...
},
{
  ...
  "type": "Theorem",
  "number": "1.19.5",
  "title": "Cyclotomic poylnomials.",
  "body": " Cyclotomic poylnomials   Let be a positive integer.    .     is irreducible over .      "
},
{
  "id": "th_cyc_ext",
  "level": "2",
...
},
{
  ...
  "body": " Computing cyclotomic polynomials   Given a positive integer , let denote the -th cyclotomic polynomial.    .    If is odd, then .    If is prime, then .    If is a prime and , then .    If are distinct primes, then .       Statement (1) was proved as part of the proof of .  The remaining statements can be proved using the following argument: if and are (a) monic, (b) separable, and (c) have the same degree, then if and only if they have the same roots. Note that for all , since is irreducible and , is separable.  For example, consider (2). First observe that since is odd, we have . Thus . Furthermore, since , is even. Thus is monic. Lastly, the roots of are precisely the negatives of the roots of . Suppose is a primitive -th root of unity. Since is odd, we cannot have . It follows that . This shows that . We conclude that the roots of are precisely the distinct primitive -th roots of unity. It follows that both polynomials are separable, and we have   The proofs of the rest of the statements are left as an exercise.   "
},
{
