...
},
{
  ...
  "body": " Tower law: infinite extensions  The formula is true even when one or more of the field extensions involved is infinite, using the following rules from extended arithmetic : . Equivalently, we can interpret as stating that the extension is infinite if and only if is infinite or .  "
},
{
...
},
{
  ...
  "body": " Finite extension theorem   Let be a field extension. The following statements are equivalent.    is finite.     is finitely generated and algebraic.     , where is algebraic over . In other words, is generated over by finitely many algebraic elements.      "
},
{
  "id": "s_algebraic-13",
  "level": "2",
